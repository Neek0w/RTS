...
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Berthier','Julien','20','15 rue du champion 75100','0789351676','A+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Sarrazin','Marius','25','8 rue de la Muscu 69500','0678451367','O-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Chenoll','Lohen','20','9 rue du chauffer 33140','0798123456','O+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Dautriat','Antonin','18','65 rue du cailloux 17450','0634561389','B-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Moreau','Santoine','35','3 avenue teams 30400','0678241567','A-','TRUE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Moulard','Antoine','54','90 rue sql 13500','0784645753','AB+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Vallee','Julien','98','1 rue de la prairie 15600','0678342513','O-','TRUE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Smith','Jhon','25','98 rue de l’ordinateur 12100','0789453786','A+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Lela','Erisa','18','168 rue tirana 65000','0684425632','O-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Bouquet','Carolle','69','87 rue bois de boulogne 78000','0689345623','AB+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Egloff','Nicolas','19','25 avenue marillac 34000','0789654565','B+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Pansivy','Camille','3 rue Victor Hugo Concarneau 23400','0745653423',' O+ ','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Delvaux','Anais','53 place Maurice-Charretier 12450','0678987654',' B- ','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Stains','Axel','77 Rue St Ferréol 13000','0768324556','B+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Pichet','Arthur','31 rue des Lacs 65000','0678657654','B-','TRUE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Merca','Evan','32 rue Petite Fusterie 50140','0789098734','A-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Sabatier','Clara','38 Rue Bonnet 34900','0634828925','O+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Toupin','Emma','91 rue du Château 15300','0783156734','AB-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Tarret','Charlotte','27 rue Clement Marot 75900','0625621465','B-','TRUE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Cebeaux','Adrien','32 Chemin Du Lavarin Sud 15900','0678452323','O-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Mercier','Celia','98 boulevard Aristide Briand 72000','0678546784','A-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Robie','Eva','33 Place du Jeu de Paume 19450','0698764917','A+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Lemagnant','Louise','18 rue Petite Fusterie 34620','0683565645','B-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Moreau','Antoine','22 rue de la Hulotais 17340','0682315628','O-','T');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Sandler','Adam','48 boulevard de Prague 21630','0735678536','A+','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Torlet','Alexandre','2 rue Reine Elisabeth 47000','0798351567','AB-','TRUE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Gimet','Ambre','20 rue Clement Marot 23840','0678456524','O-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Talon','Baptiste','53 rue Sadi Carnot 18130','0678345462','O-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Bertrand','Clemence','99 rue de Raymond Poincaré 33000','0789356783','O-','FALSE');
INSERT INTO Donneur(nom,prenom,age,adresse,numTel,groupeSanguin,maladie) VALUES ('Parnedaud','Enzo','31 rue de verdun 33140','0678845623','O+','FALSE');
...
INSERT INTO PocheDisponible(datePrelevement,datePeremption,valider,idTypeSang,idprix,idLab,idCentre,idDonneur) VALUES ('2022-05-0','2022-06-0','TRUE','1','1','9','6','24');
INSERT INTO PocheDisponible(datePrelevement,datePeremption,valider,idTypeSang,idprix,idLab,idCentre,idDonneur) VALUES ('2022-05-0','2022-06-0','TRUE','2','2','2','10','4');
